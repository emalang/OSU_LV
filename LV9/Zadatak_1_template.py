...
my_callbacks = [
    keras.callbacks.TensorBoard(log_dir = 'logs/cnn_earlyStop',  #direktoji u koji se sprema,tu mienjamo zavisi sta nam treba i sta radimmo
                                update_freq = 100),
    keras.callbacks.EarlyStopping(monitor="val_loss", patience=40) #rano zaustavljanje, patience nakon koliko epoha koje se ponavljaju
]
